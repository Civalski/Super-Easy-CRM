...
export interface EditarLeadDrawerProps {
  open: boolean
...
export function EditarLeadDrawer({ open, prospectoId, onClose, onSaved }: EditarLeadDrawerProps) {
    ...
    <SideCreateDrawer open={open} onClose={onClose} maxWidthClass="max-w-md">
      <div className="flex h-full flex-col">
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
              Atualize os dados do lead no funil.
            </p>
          </div>
          <button
            type="button"
        ...
        {loading ? (
          ...
          <form id="editar-lead-form" onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              <div>
                <label htmlFor="editar-razaoSocial" className={LABEL_CLASS}>
                  Nome / Razão social <span className="text-red-500">*</span>
                </label>
                <input
                  id="editar-razaoSocial"
                  type="text"
              ...
              <div>
                <label htmlFor="editar-nomeFantasia" className={LABEL_CLASS}>
                  Empresa / Nome fantasia
                </label>
                <input
                  id="editar-nomeFantasia"
                  type="text"
              ...
              <div>
                <label htmlFor="editar-telefone" className={LABEL_CLASS}>
                  Telefone
                </label>
                <input
                  id="editar-telefone"
              ...
              <div>
                <label htmlFor="editar-email" className={LABEL_CLASS}>
                  E-mail
                </label>
                <input
                  id="editar-email"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="editar-municipio" className={LABEL_CLASS}>
                    Município
                  </label>
                  <input
                    id="editar-municipio"
                ...
                <div>
                  <label htmlFor="editar-uf" className={LABEL_CLASS}>
                    UF
                  </label>
                  <input
                    id="editar-uf"
              ...
              <div>
                <label htmlFor="editar-observacoes" className={LABEL_CLASS}>
                  Observações
                </label>
                <textarea
