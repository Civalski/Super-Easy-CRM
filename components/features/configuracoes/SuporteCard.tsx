/**
 * Card de suporte com links de contato.
 */
'use client'

import { Instagram, Mail, MessageCircle } from '@/lib/icons'
      ...
      <div className="flex items-start gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="mb-3 text-xs text-gray-500 dark:text-gray-400">
            Entre em contato por WhatsApp, Instagram ou e-mail para reportar problemas, sugestoes ou duvidas.
          </p>
